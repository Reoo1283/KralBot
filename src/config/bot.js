...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "Haxball Baba Futsal!", // required by Discord API, not shown in the client
        state: "BaBa Haxball için geliştirmeler için çalışyor!",     // this is what people actually see
        type: 0,               // Custom
      },
    ],
  },
